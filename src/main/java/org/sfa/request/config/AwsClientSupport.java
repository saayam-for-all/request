 ...
 * endpoint. When {@code aws.endpoint-override} is set — the local LocalStack demo — the
 * endpoint is redirected and static dummy credentials are used, because LocalStack
 * requires credentials to be present but does not validate them.
 */
