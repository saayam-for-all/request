...
public class NotificationDispatchServiceImpl implements NotificationDispatchService {
    ...
    private void route(NotificationEvent event, NotificationRecipient recipient) {
        switch (recipient.getChannel()) {
            ...
            case IN_APP -> routeInApp(event, recipient);
    ...
    private void routeInApp(NotificationEvent event, NotificationRecipient recipient) {
        inAppNotificationService.record(event, recipient);
    }
}
